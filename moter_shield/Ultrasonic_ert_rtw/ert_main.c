...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T) ((Ultrasonic_M->Timing.clockTick0 * 1)
    + 0)
    ;
  Ultrasonic_step0();
  ...
  if (need2runFlags[1]) {
    ...
    {
     case 1 :
      currentTime = (extmodeSimulationTime_T) ((Ultrasonic_M->Timing.clockTick1 *
        10) + 0)
        ;
      Ultrasonic_step1();
...
int main(void)
{
  ...
  errorCode = extmodeInit(Ultrasonic_M->extModeInfo, &rtmGetTFinal(Ultrasonic_M));
  if (errorCode != EXTMODE_SUCCESS) {
